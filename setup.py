...
LONG_DESCRIPTION = (
    ...
    'lib-anim is a Python package to create interactive 2D (and soon 3D) animations '
    'with a simple, content-oriented API. It wraps Qt (and soon matplotlib) details '
